...
### Custom Breadcrumbs
You can set custom breadcrumbs in your ios application using [Fn setBreadCrumbAt: forCrumb:]. These breadcrumbs will be shown along with the activity trail when an issue is reported.

...
# Objective-c framework Version: 2.2.0
...
### Custom Breadcrumbs
You can set custom breadcrumbs in you android application using [Fn setBreadCrumbAt: forCrumb:]. These breadcrumbs will be shown along with the activity trail when an issue is reported.

```objc
        [Fn setBreadCrumbAt:self forCrumb:@"clicked on payment_package_two"];
```
...
Activity Trail
	...
	LoginController:viewDidAppear                         09:21:53:927
	UIApplication:applicationDidBecomeActive              09:21:54:081
	PurchaseController:viewDidLoad                        09:22:09:670
        PurchaseController:clicked on payment_package_two     09:40:24:235
```

...
### Custom Breadcrumbs
You can set custom breadcrumbs in you ios application using [Fn setBreadCrumbAt: forCrumb:]. These breadcrumbs will be shown along with the activity trail when an issue is reported.

...
```
### Custom Breadcrumbs
You can set custom breadcrumbs in you android application using Fn.setBreadCrumb(). These breadcrumbs will be shown along with then activity trail when an issue is reported.

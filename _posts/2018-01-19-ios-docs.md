...
@implementation LoginViewController
	...
	-(void) fbLogin:(UITapGestureRecognizer *)recognizer {
	    // Here function 'makeLoginApiCall:withUserId:' is expected to be called in under '10000' milliseconds.
	    Observer *observer =  [[[Fn observe] expectedChainedExecutionTime:10000]  
	    				nextFunctionSignature:@selector(makeLoginApiCall:withUserId:withPermissions:) 
					inClass:[self class]];
	...
	-(void)initiateFacebookLogin {
	    ...
	    [loginManager logInWithReadPermissions:@[@"email",@"public_profile",@"publish_actions"] fromViewController:self 
		    ...
		    Observer *observer =  [[[Fn observe] expectedChainedExecutionTime:5000]  
						...
						inClass:[self class]];
		    [Fn call:@selector(makeLoginApiCall:withUserId:withPermissions:) target:self observer:observer
	...
	- (Boolean) makeLoginApiCall:(NSString *)fbToken withUserId:(NSString *) userId withPermissions:(NSArray *) approvedPermissions {

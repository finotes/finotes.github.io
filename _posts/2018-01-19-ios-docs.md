...
#import <FinotesCore/Fn.h>
    ...
    [Fn call:@selector(getUserNameFromDb:) target:self observer:observer withParameters:@"123-sd-12"];
}
...
```objective-c
    ...
    Observer *observer =  [[Fn observe] expectedExecutionTime:1400];
    [Fn call:@selector(getUserNameFromDb:) target:dbUtils observer:observer withParameters:@"123-sd-12"];
}
